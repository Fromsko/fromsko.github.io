...
$\frac {\partial<sup>r} {\partial \omega</sup>r} \left(\frac {y^{\omega}} {\omega}\right)
= \left(\frac {y^{\omega}} {\omega}\right) \left\{(\log y)<sup>r + \sum_{i=1}</sup>​<sup><sup>r \frac {(-1)</sup></sup>​<sup> Ir \cdots (r-i+1) (\log y)</sup>{ri}} {\omega^i} \right\}$
